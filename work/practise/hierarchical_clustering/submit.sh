...
HADOOP_OUT=/app/inf/mpi/chenkang02/output
HADOOP_DATA_DIR=
...
sh ${HPC_HOME}/bin/qsub_f --hdfs ${HADOOP_FS} --ugi ${HADOOP_UGI} --pushcore no --core-size-limit 8999 --hpcugi ${HADOOP_UGI} --hout ${HADOOP_OUT} --files ${CURR_DIR}/hierachical_clustering -N chenkang02_clustering  -l nodes=${NUM_NODES},walltime=72000 ${CURR_DIR}/run_mpi.sh 
